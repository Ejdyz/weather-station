...
type TypesMap = {
  value: string;
  label: "temperature" | "humidity" | "pressure" | "wind_speed_ms" | "wind_speed_kmh" | "wind_direction" | "rain_mm" ;
}
    ...
    >
      ...
      <div className="grid gap-1.5">
        <div className="text-muted-foreground block">
          { formatWeatherData("date_full_numeric", payload[0].payload.recorded_at)}
        </div>
                ...
                <>
                  {itemConfig?.icon ? (
                    ...
                    !hideIndicator && (
                      <div
                        className={cn(
                          "shrink-0 border border-gray-200 rounded-[2px]  bg-(--color-bg)",
                          {
        ...
        return (
          ...
          >
            {itemConfig?.icon && !hideIcon ? (
              ...
              <div
                className="h-2 w-2 shrink-0 border-1 border-gray-400 rounded-[2px]"
                style={{
                  backgroundColor: "red",
                }}
              />
