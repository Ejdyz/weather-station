				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"cursor-pointer flex p-1 rounded-md min-h-10 h-auto items-center justify-between text-white bg-white/20 hover:bg-white/40 [&_svg]:pointer-events-auto",
								...
								<div className="flex justify-between items-center w-full">
									...
									<div className="flex items-center justify-between">
										<div
											...
											className="flex items-center justify-center h-4 w-4 mx-2 cursor-pointer text-white hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 rounded-sm">
												...
												return (
													<CommandItem
														...
														<div
															...
															aria-hidden="true">
															<CheckIcon className="h-4 w-4 stroke-whi" />
														</div>
														{option.icon && (
															<option.icon
												...
												<CommandItem
													...
													<div
														className={cn(
															"mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-primary",
															isSelected
																? "bg-cyan-600 text-primary-foreground border-0"
																: "opacity-50 [&_svg]:invisible"
														)}
														aria-hidden="true">
														<CheckIcon className="h-4 w-4 stroke-white" />
